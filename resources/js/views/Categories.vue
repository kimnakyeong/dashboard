                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="(category, index) in categories" :key="index">
                            ...
                            <td>
                                <button class="btn btn-primary btn-sm" v-on:click="editCategory(category)">update</button>
                                <button class="btn btn-danger btn-sm" v-on:click="deleteCategory(category)">delete</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <form v-on:submit.prevent="updateCategory">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            ref="editCategoryImageDisplay" class="w-150px" />
                        </div>
